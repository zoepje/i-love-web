...
<div class="experiments">
	...
	<div class="container-guitar ex">
		...
		<div class="guitar">
			...
			<svg class="guitarSVG" viewBox="0 0 1256 3200">
				...
				<g class="guitarBody">
					<path
						d="M 626 1600 C 1135 1600 1116 1738 1055 2176 C 1035 2323 1721 3176 622 3194 C -465 3176 221 2323 201 2176 C 140 1738 121 1600 630 1600 Z"
						fill="var(--body2)"
					...
					<circle
						...
						r="162"
						fill="none"
						stroke="var(--sound-hole-ring)"
						stroke-width="5"
					/>
					<path
						d="M 390 2490 H 862 V 2570 H 798 Q 626 2635 454 2570 H 390 Z"
						fill="var(--bridge-head)"
					/>
					<path
						d="M484 2527 L 772 2513"
						stroke-width="10"
						stroke="var(--nut)"
				...
				<g class="guitarNeck">
					...
					<path
						d="M 462 345 L 562 325 M 462 231 L 562 211 M 462 112 L 562 92 M 790 345 L 690 325 M 790 231 L 690 211 M 790 112 L 690 92"
						stroke="var(--tuners)"
						stroke-width="14"
					/>
					...
					<path
						d="M 530 458 H 722 Q 745 414 746 400 L 766 60 Q 769 7 717 7 H 535 Q 487 7 490 60 L 506 400 Q 507 414 530 458 Z"
						fill="var(--bridge-head)"
					/>
					<path d="M 528 455 H 724" stroke-width="14" stroke="var(--nut)" stroke-linecap="round" />
					<path
						class="frets"
						d="M 530 580 H 722 M 530 695 H 722 M 530 791 H 722 M 530 891 H 722 M 530 976 H 722 M 530 1064 H 722 M 530 1145 H 722 M 530 1223 H 722 M 530 1293 H 722 M 530 1364 H 722 M 530 1426 H 722 M 530 1485 H 722 M 530 1545 H 722 M 530 1600 H 722 M 530 1648 H 722 M 530 1696 H 722 M 530 1744 H 722 M 530 1785 H 722 M 530 1825 H 722 M 530 1866 H 722"
						stroke-width="5"
						stroke="var(--frets)"
						stroke-linecap="round"
					/>
				...
				<g class="strings" fill="none" stroke-width="7" stroke="var(--strings)">
					<path class="string1" d="M 542 2560 Q 542 1507 542 455 L 567 325">
						<animate
							class="string"
							attributeName="d"
							values="M 542 2560 Q 542 1507 542 455 L 567 325"
							begin="indefinite"
							dur="0.5s"
							repeatCount="none"
						/>
					...
					<path class="string2" d="M 576 2559 Q 576 1507 576 455 L 567 211">
						<animate
							class="string"
							attributeName="d"
							values="M 576 2559 Q 576 1507 576 455 L 567 211"
							begin="indefinite"
							dur="0.5s"
							repeatCount="none"
						/>
					...
					<path class="string3" d="M 610 2557 Q 610 1507 610 455 L 567 92">
						<animate
							class="string"
							attributeName="d"
							values="M 610 2557 Q 610 1507 610 455 L 567 92"
							begin="indefinite"
							dur="0.5s"
							repeatCount="none"
						/>
					...
					<path class="string4" d="M 642 2555 Q 642 1507 642 455 L 685 92">
						<animate
							class="string"
							attributeName="d"
							values="M 642 2555 Q 642 1507 642 455 L 685 92"
							begin="indefinite"
							dur="0.5s"
							repeatCount="none"
						/>
					...
					<path class="string5" d="M 676 2553 Q 676 1507 676 455 L 685 211">
						<animate
							class="string"
							attributeName="d"
							values="M 676 2553 Q 676 1507 676 455 L 685 211"
							begin="indefinite"
							dur="0.5s"
							repeatCount="none"
						/>
					...
					<path class="string6" d="M 710 2550 Q 710 1507 710 455 L 685 325">
						<animate
							class="string"
							attributeName="d"
							values="M 710 2550 Q 710 1507 710 455 L 685 325"
							begin="indefinite"
							dur="0.5s"
							repeatCount="none"
						/>
	...
	<div class="stereo ex">
		...
		<section class="master-controls">
			...
			<datalist id="gain-vals">
				<option value="0" label="min"> </option><option value="2" label="max"> </option></datalist
			>
			<label for="volume">VOL</label>

			<input
				bind:this={pannerControl}
				type="range"
				id="panner"
			...
			<datalist id="pan-vals">
				<option value="-1" label="left"> </option><option value="1" label="right">
				</option></datalist
			>
	...
	<div class="piano ex">
		<h2>Keyboard</h2>
		<p>
			Play a fun song! To sustain a note, click and hold a key, then move your mouse off the
			keyboard before releasing the click. The note will keep playing until you stop it by clicking
			on the key again.
		</p>
	...
	<div class="dog ex">
		<h2>Doggie</h2>
		<svg
			class="dachshund-animation"
			xmlns="http://www.w3.org/2000/svg"
			viewBox="-50 0 1200 1080"
			width="500"
			class:animate={animations['dog']}
		>
			<Dachshund />
		</svg>
